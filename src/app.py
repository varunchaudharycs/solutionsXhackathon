   ...
   if(endpnt == 'payments'):
           ...
           if action.lower() == "send":
               if info['firstName'] == name.lower():
                   ...
                   if amount > info["maxtransferred"] + 200:
                       message = "Anomaly is Detected in your account"
       ...
       for info in data:
           if info['firstName'] == 'self' and info['lock']==1:
               message = "Sorry!Unfortunatley your account is locked, we can't process your transaction"
       print(message)
       reply = {
       ...
       if last4 == int(acc_no[-4:]):
           ...
           message = "Sorry your number doesn't match. We have blocked your account, Please contact your nearest branch"
